                ...
                <div className="active">
                  ...
                  <div className="tab-content">
                    <div style={{ display: "block" }}>
                      ...
                      >
                        <div style={{ display: "block" }} onClick={handleGoToQuizpage}>
                          <ul className="nav-tab">
                            <li className="list">
                              <div
                                style={{
                              ...
                              >
                                <button className="btn"  style={{backgroundColor:'rgba(244,245,247)'}}>
                                  <span
                                    style={{
                                      fontWeight: "900",
                                      lineHeight: "0.5",
                              ...
                              >
                                <button className="btn" style={{backgroundColor:'white'}}>
                                  <DeleteIcon style={{color:'rgba(213, 214, 216)'}}/>
                                </button>
                              </div>
                            </li>
                          </ul>
                          <div className="div">
                            ...
                            >
                              <label className="label"> Total Points: {props.getcount}</label>
                            </div>
                            <div
                        ...
                        <p className="para">
                          {" "}
                          You can also{" "}
                          <a className="bulk" onClick={() => setimportShow(!importShow)}>bulk import questions</a> or{" "}
                          <a className="bulk"onClick={() => setbulkShow(!bulkShow)}>bulk create questions</a>.
                        </p>
                        { importShow?
                            ...
                            <div className="upper-heading">
                              <h3 className="h3">
                                ...
                                <div className="cancel-div">
                                  ...
                                  > <CloseIcon onClick={() => setimportShow(!importShow)} style={{cursor:'pointer'}}/>
                                  </button>
                                </div>
                              </h3>
                              <div
                              ...
                              >
                                <p>
                                  ...
                                  the quiz questions. Once you upload the file,
                                  the questions will be imported to this quiz.
                                </p>
                            ...
                            <div className="upper-heading">
                              <h3 className="h3">
                                ...
                                <div className="cancel-div">
                                  ...
                                  > <CloseIcon onClick={() => setbulkShow(!bulkShow)} style={{cursor:'pointer'}}/>
                                  </button>
                                </div>
                              </h3>
                              <div
                              ...
                              >
                                <p>
                                  ...
                                  number of options using a single click instead
                                  of creating each question individually.{" "}
                                </p>
